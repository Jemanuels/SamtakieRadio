package za.co.samtakie.samtakieradio.client;
...
public class MediaBrowserHelper {
     ...
     * any connections to the {@link MusicPlayerService} happens via the {@link android.support.v4.media.session.MediaSessionCompat}.
     */
